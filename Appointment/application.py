...
def medical_app_populate():
    obj1 = MedicalAppointment(AppointmentId="1", AppointmentNumber="10", PatientId="1", DoctorId="1", AppointmentDate=datetime.datetime(2021, 3, 27, 9, 0))
    obj2 = MedicalAppointment(AppointmentId="2", AppointmentNumber="20", PatientId="2", DoctorId="2", AppointmentDate=datetime.datetime(2021, 4, 2, 17, 0))
    obj3 = MedicalAppointment(AppointmentId="3", AppointmentNumber="30", PatientId="3", DoctorId="3", AppointmentDate=datetime.datetime(2021, 5, 14, 15, 0))
    obj4 = MedicalAppointment(AppointmentId="4", AppointmentNumber="40", PatientId="4", DoctorId="4", AppointmentDate=datetime.datetime(2021, 6, 8, 12, 0))
    obj5 = MedicalAppointment(AppointmentId="5", AppointmentNumber="50", PatientId="5", DoctorId="5", AppointmentDate=datetime.datetime(2021, 4, 5, 15, 0))
...
def api_medicalapp_data():
    if request.method == "GET":
        ...
        data = MedicalAppointment(AppointmentId=content['AppointmentId'], AppointmentNumber=content['AppointmentNumber'], PatientId=content['PatientId'], DoctorId=content['DoctorId'], AppointmentDate=datetime.datetime.strptime(content['AppointmentDate'], datetime_format))
        data.save()
...
def api_each_medicalapp_data(patient_id):
    if request.method == "GET":
        ...
        content = request.json
        obj = MedicalAppointment.objects(PatientId=patient_id).first()
        obj.update(AppointmentId=content['AppointmentId'], AppointmentNumber=content['AppointmentNumber'], PatientId=content['PatientId'], DoctorId=content['DoctorId'], AppointmentDate=datetime.datetime.strptime(content['AppointmentDate'], datetime_format))
...
def getDoctorRanking():
    ...
    for profile in dummy_doctor_profiles:
        ...
        if matched_symptoms:
            ...
            Doctors_date.append(("" + Doctor_id + ": " + str1 + "     " + Doctor_date + "   " + Doctor_time))
